...
/**
 * Servlet implementation class NotifyAction
 */
public class NotifyAction extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("....................notifyaction start.....................");
		Collection<String> coolen = params.values();
		
		for(Object object : coolen){
			System.out.println("NotifyAction       "+object.toString());
			
		}
		System.out.println("....................notifyaction end.....................");
		boolean signVerified = false;
		try {
			signVerified = AlipaySignature.rsaCheckV1(params, AlipayConfig.alipay_public_key, AlipayConfig.charset, AlipayConfig.sign_type);
			//signVerified = AlipaySignature.rsaCheckV1(params, AlipayConfig.alipay_public_key, AlipayConfig.charset, AlipayConfig.sign_type);
			System.out.println("NotifyAction"+signVerified);
